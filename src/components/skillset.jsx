    ...
    render() {
        return(
            <div style={{ color:'black', position:'relative' , width:'100%'}}>
                ...
                <div>
                <Container fluid={true} style={{ width:'100%', paddingLeft:'0', opacity:'1.0' }} >
                ...
                <ProgressBar  lg={6} md={6} sm={12} xs = {12} id="pb1" name="pb1" style={{width:'100%', opacity:'1.0' }}striped variant="success" now={65}  label="Good" animated></ProgressBar>
                </Card>
                </div>
                <br></br>
                <div style={{paddingLeft:'0em'}} className="lg-6 sm-6 xs-6 md-6">
                    <Card style={{width:'100%'}}>
